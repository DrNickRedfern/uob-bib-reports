...
research_organisations <- research_organisations %>%
  ...
  mutate(collaboration = case_when(length(organisation_name) == 1 ~ "Single authored",
                                   n_distinct(organisation_name) == 1 ~"Institutional co-authored",
                                   n_distinct(country_name) == 1 ~ "National collaboration",
